...
urlpatterns = [
    ...
    url(r'^sem_results/([1-9]|10)/([A-Z]{2})/$', views.sem_results,  name='sem_results'),
    ...
    url(r'^subject_results/(\w+)/([A-Z]{2})/analytics/$', views.subject_analytics, name='subject_analytics'),
    url(r'^subject_results/(\w+)/analytics/$', views.subject_analytics, name='subject_analytics'),
